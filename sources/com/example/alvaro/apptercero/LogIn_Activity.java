...
public class LogIn_Activity extends AppCompatActivity implements OnNavigationItemSelectedListener {
    public static volatile transient /* synthetic */ IncrementalChange $change;

    /* renamed from: com.example.alvaro.apptercero.LogIn_Activity$1 reason: invalid class name */
    class AnonymousClass1 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public final /* synthetic */ LogIn_Activity this$0;
        ...
        AnonymousClass1(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case -371942269:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/LogIn_Activity$1"}));
            }
        }

        public static /* synthetic */ Object access$super(AnonymousClass1 r5, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
        ...
        public AnonymousClass1(LogIn_Activity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                ...
                objArr[0] = objArr;
                objArr[1] = this$02;
                this$02 = (LogIn_Activity) objArr[1];
                this((Object[]) incrementalChange.access$dispatch("init$args.([Ljava/lang/Object;Lcom/example/alvaro/apptercero/LogIn_Activity;)Ljava/lang/Object;", objArr), null);
            }
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/LogIn_Activity$1;Lcom/example/alvaro/apptercero/LogIn_Activity;)V", this, this$02);
            }
        }
    }

    /* renamed from: com.example.alvaro.apptercero.LogIn_Activity$2 reason: invalid class name */
    class AnonymousClass2 implements DialogInterface.OnClickListener {
        ...
        AnonymousClass2(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case 761248324:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/LogIn_Activity$2"}));
            }
        }

        public static /* synthetic */ Object access$super(AnonymousClass2 r5, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                    return super.toString();
                case -1600833221:
        ...
        public void onClick(DialogInterface dialog, int id) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onClick.(Landroid/content/DialogInterface;I)V", this, dialog, new Integer(id));
                return;
            }
            this.this$0.finish();
        }

        public AnonymousClass2(LogIn_Activity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = new Object[2];
            ...
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/LogIn_Activity$2;Lcom/example/alvaro/apptercero/LogIn_Activity;)V", this, this$02);
            }
        }
    }

    LogIn_Activity(Object[] objArr, InstantReloadException instantReloadException) {
        String str = objArr[0];
        switch (str.hashCode()) {
            case -2089128195:
                return;
            case 1256829939:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/LogIn_Activity"}));
        }
    }

    public static /* synthetic */ Object access$super(LogIn_Activity logIn_Activity, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
    ...
    public void m_log_in(View view) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("m_log_in.(Landroid/view/View;)V", this, view);
            return;
        }
        TextView name_tv = (TextView) findViewById(R.id.user_txtv_log_in);
        TextView password_tv = (TextView) findViewById(R.id.password_txtv_log_in);
        User user = new SqlliteConsulter(getApplicationContext()).findUser(name_tv.getText().toString());
        if (user == null) {
            Toast.makeText(this, "Usuario o password mal", 0).show();
            name_tv.setText("");
            password_tv.setText("");
        } else if (user.getPassword().equals(password_tv.getText().toString())) {
            Toast.makeText(this, "Esta Logeado", 0).show();
            name_tv.setText("");
            password_tv.setText("");
            new MainActivity().setLogeado(true);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.v_log_in);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Boolean) incrementalChange.access$dispatch("onNavigationItemSelected.(Landroid/view/MenuItem;)Z", this, item)).booleanValue();
        }
        int id = item.getItemId();
        if (id == R.id.nav_log_in) {
            Intent intent = new Intent(this, LogIn_Activity.class);
            Toast.makeText(this, "logeate", 0).show();
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            startActivity(new Intent(this, MainActivity.class));
            Toast.makeText(this, "Home", 0).show();
        } else if (id == R.id.nav_tool) {
            startActivity(new Intent(this, Tools_Activity.class));
            Toast.makeText(this, "herramientas", 0).show();
        } else if (id == R.id.nav_add) {
            startActivity(new Intent(this, Add_Activity.class));
            Toast.makeText(this, "aumentar", 0).show();
        } else if (id == R.id.nav_delete) {
            Toast.makeText(this, "borrar", 0).show();
        } else if (id == R.id.nav_edit) {
            Toast.makeText(this, "edit", 0).show();
        } else if (id == R.id.nav_exit) {
            new Builder(this).setMessage("Are you sure you want to exit?").setCancelable(false).setPositiveButton("Yes", new AnonymousClass2(this)).setNegativeButton("No", null).show();
        }
        finish();
    ...
    public LogIn_Activity() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/LogIn_Activity;)V", this);
        }
    }
}
