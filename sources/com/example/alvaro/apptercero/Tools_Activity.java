...
public class Tools_Activity extends AppCompatActivity implements OnNavigationItemSelectedListener {
    public static volatile transient /* synthetic */ IncrementalChange $change;

    /* renamed from: com.example.alvaro.apptercero.Tools_Activity$1 reason: invalid class name */
    class AnonymousClass1 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public final /* synthetic */ Tools_Activity this$0;
        ...
        AnonymousClass1(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case 1044132547:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/Tools_Activity$1"}));
            }
        }
        ...
        public AnonymousClass1(Tools_Activity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                ...
                objArr[0] = objArr;
                objArr[1] = this$02;
                this$02 = (Tools_Activity) objArr[1];
                this((Object[]) incrementalChange.access$dispatch("init$args.([Ljava/lang/Object;Lcom/example/alvaro/apptercero/Tools_Activity;)Ljava/lang/Object;", objArr), null);
            }
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/Tools_Activity$1;Lcom/example/alvaro/apptercero/Tools_Activity;)V", this, this$02);
            }
        }
    }

    /* renamed from: com.example.alvaro.apptercero.Tools_Activity$2 reason: invalid class name */
    class AnonymousClass2 implements DialogInterface.OnClickListener {
        ...
        AnonymousClass2(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case -1968665286:
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/Tools_Activity$2"}));
            }
        }
        ...
        public AnonymousClass2(Tools_Activity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = new Object[2];
            ...
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/Tools_Activity$2;Lcom/example/alvaro/apptercero/Tools_Activity;)V", this, this$02);
            }
        }
    }

    Tools_Activity(Object[] objArr, InstantReloadException instantReloadException) {
        String str = objArr[0];
        switch (str.hashCode()) {
            case -2089128195:
                return;
            case 777792225:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/Tools_Activity"}));
        }
    }

    public static /* synthetic */ Object access$super(Tools_Activity tools_Activity, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
    ...
    public void m_save_user(View view) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("m_save_user.(Landroid/view/View;)V", this, view);
            return;
        }
        TextView password_tv = (TextView) findViewById(R.id.passwod_txtv);
        RadioButton superuser_rd = (RadioButton) findViewById(R.id.idsupersuper);
        String name = ((TextView) findViewById(R.id.name_txtv)).getText().toString();
        String password = password_tv.getText().toString();
        SqlliteConsulter MDB = new SqlliteConsulter(getApplicationContext());
        boolean superuser = false;
        if (superuser_rd.isChecked()) {
            superuser = true;
        }
        MDB.insertUser(name, password, superuser);
        Toast.makeText(this, "saveUser", 0).show();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.v_tools);
    ...
    public Tools_Activity() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/Tools_Activity;)V", this);
        }
    }
}
