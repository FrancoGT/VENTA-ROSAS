...
public class MainActivity extends AppCompatActivity implements OnNavigationItemSelectedListener {
    ...
    /* renamed from: com.example.alvaro.apptercero.MainActivity$1 reason: invalid class name */
    class AnonymousClass1 implements OnClickListener {
        ...
        AnonymousClass1(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case 489824419:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/MainActivity$1"}));
            }
        }
        ...
        public AnonymousClass1(MainActivity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                ...
                objArr[0] = objArr;
                objArr[1] = this$02;
                this$02 = (MainActivity) objArr[1];
                this((Object[]) incrementalChange.access$dispatch("init$args.([Ljava/lang/Object;Lcom/example/alvaro/apptercero/MainActivity;)Ljava/lang/Object;", objArr), null);
            }
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/MainActivity$1;Lcom/example/alvaro/apptercero/MainActivity;)V", this, this$02);
            }
        }
    }

    /* renamed from: com.example.alvaro.apptercero.MainActivity$2 reason: invalid class name */
    class AnonymousClass2 implements DialogInterface.OnClickListener {
        ...
        AnonymousClass2(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case 482065060:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/MainActivity$2"}));
            }
        }
        ...
        public AnonymousClass2(MainActivity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = new Object[2];
            ...
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/MainActivity$2;Lcom/example/alvaro/apptercero/MainActivity;)V", this, this$02);
            }
        }
    }
    ...
    MainActivity(Object[] objArr, InstantReloadException instantReloadException) {
        ...
        switch (str.hashCode()) {
            ...
            case 1369222390:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/MainActivity"}));
        }
    }
    ...
    private void showProducts(ListView lstProcducts) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("showProducts.(Landroid/widget/ListView;)V", this, lstProcducts);
            return;
        }
        List<Product> products = new SqlliteConsulter(getApplicationContext()).showProduct();
        if (products != null) {
            List<String> list = new ArrayList<>();
            for (Product product : products) {
                list.add("Name: " + product.getName() + "\nPrice: " + product.getCost());
            }
            lstProcducts.setAdapter(new ArrayAdapter<>(getApplicationContext(), 17367043, list));
        }
    }
    ...
    public boolean isLogeado() {
        ...
        return ((Boolean) incrementalChange.access$dispatch("isLogeado.()Z", this)).booleanValue();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "" + isLogeado(), 0).show();
        setContentView((int) R.layout.activity_main);
        android.support.v7.widget.Toolbar toolbar = (android.support.v7.widget.Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        new SqlliteConsulter(getApplicationContext());
        ...
        showProducts((ListView) findViewById(R.id.listViewProducts));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Boolean) incrementalChange.access$dispatch("onOptionsItemSelected.(Landroid/view/MenuItem;)Z", this, item)).booleanValue();
    ...
    public void setLogeado(boolean logeado2) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("setLogeado.(Z)V", this, new Boolean(logeado2));
            return;
        }
        this.logeado = logeado2;
    }
    ...
    public MainActivity() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/MainActivity;)V", this);
        }
    }
}
