...
public class Add_Activity extends AppCompatActivity implements OnNavigationItemSelectedListener {
    public static volatile transient /* synthetic */ IncrementalChange $change;

    /* renamed from: com.example.alvaro.apptercero.Add_Activity$1 reason: invalid class name */
    class AnonymousClass1 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public final /* synthetic */ Add_Activity this$0;
        ...
        AnonymousClass1(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case -1807458493:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/Add_Activity$1"}));
            }
        }
        ...
        public AnonymousClass1(Add_Activity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                ...
                objArr[0] = objArr;
                objArr[1] = this$02;
                this$02 = (Add_Activity) objArr[1];
                this((Object[]) incrementalChange.access$dispatch("init$args.([Ljava/lang/Object;Lcom/example/alvaro/apptercero/Add_Activity;)Ljava/lang/Object;", objArr), null);
            }
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/Add_Activity$1;Lcom/example/alvaro/apptercero/Add_Activity;)V", this, this$02);
            }
        }
    }

    /* renamed from: com.example.alvaro.apptercero.Add_Activity$2 reason: invalid class name */
    class AnonymousClass2 implements DialogInterface.OnClickListener {
        ...
        AnonymousClass2(Object[] objArr, InstantReloadException instantReloadException) {
            ...
            switch (str.hashCode()) {
                ...
                case -1815217852:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/Add_Activity$2"}));
            }
        }
        ...
        public AnonymousClass2(Add_Activity this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = new Object[2];
            ...
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/Add_Activity$2;Lcom/example/alvaro/apptercero/Add_Activity;)V", this, this$02);
            }
        }
    }

    Add_Activity(Object[] objArr, InstantReloadException instantReloadException) {
        String str = objArr[0];
        switch (str.hashCode()) {
            case -2089128195:
                return;
            case 1767256987:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/alvaro/apptercero/Add_Activity"}));
        }
    }

    public static /* synthetic */ Object access$super(Add_Activity add_Activity, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
    ...
    public void m_add_product(View view) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("m_add_product.(Landroid/view/View;)V", this, view);
            return;
        }
        if (new SqlliteConsulter(getApplicationContext()).AddProduct(((TextView) findViewById(R.id.productName)).getText().toString(), ((TextView) findViewById(R.id.productDescrip)).getText().toString(), ((TextView) findViewById(R.id.productoPrice)).getText().toString())) {
            Toast.makeText(this, "Se inserto el producto", 0).show();
        } else {
            Toast.makeText(this, "Error al insertar el producto", 0).show();
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.v_add);
    ...
    public Add_Activity() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lcom/example/alvaro/apptercero/Add_Activity;)V", this);
        }
    }
}
